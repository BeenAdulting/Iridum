...
repeat
 ...
 -- Menu/UI Creation
 if not isfile("iridium.priv") then
    makefolder("iridium.priv")
 end
 ...
 local function createWatermark()
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'iridium.<font color="rgb(115, 100, 215)">priv</font> - uid: <font color="rgb(115, 100, 215)">' .. uid .. '</font> / fps: <font color="rgb(115, 100, 215)">' .. fpsValue .. '</font> / ping: <font color="rgb(115, 100, 215)">' .. ping .. '</font> / time: <font color="rgb(115, 100, 215)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    Title = 'iridium.<font color="rgb(115, 100, 215)">priv</font>',
    ...
    CloneScreenGui.Name = "iridium_gui"
        ...
        function library:Notify(Text, Time)
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("iridium.priv/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                function library:refreshConfigs()
                    local tbl = {}
                    for i,v in next, listfiles("iridium.priv") do table.insert(tbl,v) end
